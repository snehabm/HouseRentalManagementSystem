...
<?php
    ...
    $sql="SELECT * from add_property join owner on owner.owner_id=add_property.owner_id where property_id='$property_id'";
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="col-sm-6">
		  ...
		  <tr>
              <td><h3>Owner:</h3></td>
              <td><h4><?php echo $rows['full_name']; ?></h4></td>
            </tr>
            <tr>
              <td><h3>Country:</h3></td>
			...
			<?php if(isset($_SESSION["email"]) && !empty($_SESSION['email'])){
              ...
              <td><h4>".$rows['contact_no']."</h4></td>
            </tr>
            <tr>
              <td><h3>Estimated Price:</h3></td>
              <td><h4>".$rows['estimated_price']."</h4></td>
            </tr>";
			}?>
          </table>
        </div>
